...
describe('BloodSugar compute', () => {
	...
	const testCases = [
		{ value: 70, period: Period.Morning, expected: 0 },
		{ value: 70, period: Period.Midday, expected: 0 },
		{ value: 70, period: Period.Evening, expected: 0 },
		{ value: 85, period: Period.Morning, expected: 2 },
		{ value: 85, period: Period.Midday, expected: 4 },
		{ value: 85, period: Period.Evening, expected: 2 },
	...
	test.each(testCases)('compute($value, $period) should return $expected', ({ value, period, expected }) => {
...
describe('BloodSugar GetRatio', () => {
	...
	const testCases = [
		{ value: 70, period: Period.Morning, expected: 'INSU' },
		{ value: 110, period: Period.Midday, expected: '5' },
	];

	test.each(testCases)('GetRatio($value, $period) should return $expected', ({ value, period, expected }) => {
